 ...
 *
 * Note: `gapsAbove50Ms` and `maxGapMs` are not measured live by the recording
 * health tracker (they are computed by the offline `tools/validate_session.py`).
 * They are kept here for schema completeness and default to 0 until a future
 * live gap tracker fills them.
 */
